...
# Cuarto Modelo Semilla 805408 y 16 celdas
# Importar datos y configurar semilla
import.data <- fread("indicadores_financieros_1.csv", stringsAsFactors = TRUE, data.table = FALSE, check.names = TRUE)
...
# Inicializar y entrenar el SOM en una grilla de 3x2 (hexagonal)
som_grid <- kohonen::somgrid(4, 4, "hexagonal")
trained_som <- kohonen::som(
  data_matrix,
  grid = som_grid,
  maxNA.fraction = 0.25,
...
# Guardar el archivo actualizado con Superclass y SOM.cell
write.csv(data_clean, "aweSOM_16_805408.csv", row.names = FALSE)
cat("Los resultados del modelo SOM, incluyendo celdas y superclases, se han guardado en 'aweSOM_06_805408.csv'.\n")
...
aweSOMplot(som = trained_som, type = "Cloud", data = data_clean,
           variables = c("Short_name"), superclass = superclasses, 
           obsNames = data_clean[, "Short_name_año"],  # Usar "Short_name" y año en la leyenda         
           palvar = "rainbow", legendFontsize = 15, size = 615)
...
# Quinto Modelo Semilla 189109 y 6 celdas
# Importar datos y configurar semilla
import.data <- fread("indicadores_financieros_1.csv", stringsAsFactors = TRUE, data.table = FALSE, check.names = TRUE)
...
# Guardar el archivo actualizado con Superclass y SOM.cell
write.csv(data_clean, "aweSOM_06_189109.csv", row.names = FALSE)
cat("Los resultados del modelo SOM, incluyendo celdas y superclases, se han guardado en 'aweSOM_06_805408.csv'.\n")
...
# Sexto Modelo Semilla 189109 y 8 celdas
# Importar datos y configurar semilla
import.data <- fread("indicadores_financieros_1.csv", stringsAsFactors = TRUE, data.table = FALSE, check.names = TRUE)
...
# Guardar el archivo actualizado con Superclass y SOM.cell
write.csv(data_clean, "aweSOM_08_189109.csv", row.names = FALSE)
cat("Los resultados del modelo SOM, incluyendo celdas y superclases, se han guardado en 'aweSOM_06_805408.csv'.\n")
...
# Séptimo Modelo Semilla 123456 y 6 celdas
# Importar datos y configurar semilla
import.data <- fread("indicadores_financieros_1.csv", stringsAsFactors = TRUE, data.table = FALSE, check.names = TRUE)
...
# Guardar el archivo actualizado con Superclass y SOM.cell
write.csv(data_clean, "aweSOM_06_123456.csv", row.names = FALSE)
cat("Los resultados del modelo SOM, incluyendo celdas y superclases, se han guardado en 'aweSOM_06_805408.csv'.\n")
...
# Octavo Modelo Semilla 123456 y 8 celdas
# Importar datos y configurar semilla
import.data <- fread("indicadores_financieros_1.csv", stringsAsFactors = TRUE, data.table = FALSE, check.names = TRUE)
...
# Guardar el archivo actualizado con Superclass y SOM.cell
write.csv(data_clean, "aweSOM_08_123456.csv", row.names = FALSE)
cat("Los resultados del modelo SOM, incluyendo celdas y superclases, se han guardado en 'aweSOM_06_805408.csv'.\n")
